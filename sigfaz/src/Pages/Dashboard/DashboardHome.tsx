...
export default function DashboardHome() {
  ...
  //dados falsos, ja que a api nao esta completa e nao retorna nada por enquanto
  const [dataFazenda, setDataFazenda] = useState({
    name: 'Ricardo Oliveira',
    date: "(22/05/2026)",
    totalCoast: "R$ 5.521.531,12",
    production: "12.450 MS",
    activeArea: "1.250 ha"
  })


  //requisicao na api, com o servidor local, ele bate na api e retorna 200, 
  useEffect(()=>{
    fetch('http://127.0.0.1:8000/dashboard').then((response) => {if (response.ok) {
      console.log("conectou, mas como tem um pass, n vem nada")
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-row justify-between items-center mb-2">
        <div>
          <h1 className="text-3xl font-bold text-gray-800">Olá, {dataFazenda.name}!</h1>
          <p className="mt-1 text-gray-500">Aqui está o resumo da sua fazenda para hoje {dataFazenda.date}.</p>
        </div>
        {/* Canto Direito */}
