  ...
  return (
    <div className="flex flex-col text-left m-10 g-4">
      ...
      <div className="w-full p-1 gap-3 flex flex-row items-center justify-center">
        ...
        <Panel bgColor="bg-blue-100" title="CUSTO MÉDIO OPERACIONAL" icon={<DollarSign className="text-gray-700" size={20} />} value={new Intl.NumberFormat("pt-BR", { style: "currency", currency: "BRL" }).format(custoMedio)} subtitle="Inclui insumos a maquinário"/>
      </div>
      ...
      <div className="w-full mx-auto bg-white rounded-t-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        {loading ? (
          ...
          <ListaTalhoes talhoes={talhoesPagina} />
        )}
