...
function Login() {
  ...
  const handleLogin = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
     //retorna um objeto com o token e o usuário, que é salvo no localStorage para uso futuro
  ...
  return (
    <div className="bg-[#1dd05f] min-h-screen flex flex-col justify-center items-center">
      <form onSubmit={handleLogin} className="flex flex-col bg-white w-[90%] max-w-100 p-7.5 rounded-[10px] shadow-[0_4px_10px_rgba(0,0,0,0.2)]">
      ...
      <div className="text-white mt-5 text-[12px] text-center">© 2026 SIGFaz - Sistema Integrado de Gestão Fazendária</div>
    </div>
  );
}
